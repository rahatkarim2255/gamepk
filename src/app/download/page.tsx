...
import { AppRatingBadge } from "@/components/seo/RatingBadge";
import { Container, SectionHeading } from "@/components/ui";
import { AnimateIn } from "@/components/ui/AnimateIn";
import { APP_DETAILS, DOWNLOAD_URL } from "@/lib/constants";
import { DOWNLOAD_FAQS } from "@/lib/faqs";
  ...
  return (
    <>
            ...
            <AnimateIn delay={80}>
              <div className="mt-8 space-y-5 text-zinc-400 leading-relaxed">
                <p>
                  ...
                  <strong className="text-zinc-200">GamePK download</strong>. Always
                  use this official page (
                  <strong className="text-zinc-200">gamepk.net.pk/download</strong>)
                  and avoid fake APK links.
                </p>
                ...
                <p className="pt-2 text-sm text-zinc-500">
                  ...
                  {" · "}
                  <Link href="/pc" className="text-red-400 hover:text-red-300">
                    PC guide
                  </Link>
                  {" · "}
      ...
      <FaqSection
        faqs={DOWNLOAD_FAQS}
        title="Download FAQs"
        subtitle="Safe install tips for the official GamePK APK."
      />
    </>
  );
}
